(function () {
  ...
  // BEGIN CONFIG (generated by scripts/generate-site-config.py)
  ...
  var githubAPIBase = "https://api.github.com/repos/T3pp31/Transnote";
  // END CONFIG
  ...
  fetch(githubAPIBase + '/releases/latest')
  ...
  var releasesAPIBase = githubAPIBase + '/releases';
