...
1. DMG を開き、**初めにお読みください.txt** で Gatekeeper 手順を確認する
2. **インストール.command** を実行する（右クリック → 開く、またはターミナル）
3. 初回起動時に Gatekeeper 警告が出た場合は、右クリック → 開く
4. 初回利用時に Whisper モデルをダウンロードする
